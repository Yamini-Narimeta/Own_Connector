...
/**
 * A <code>CustomConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link CustomConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-07-11T11:56:11+05:30", comments = "Build UNNAMED.2793.f49b6c7")
public class CustomConnectorLifecycleInjectionAdapter
    extends CustomConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(CustomConnectorLifecycleInjectionAdapter.class);
